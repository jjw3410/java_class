...
public class B03_typeCasting {
	...
	public static void main(String[]args) {
		...
		byte _byte=10;
		int _int=20_0000_0000;//int리터럴은 _를 통해 자릿수 표현이 가능
		//1. 자연스러운 타입 캐스팅
		_int=_byte;
		...
		//3. 정수타입은 더 작은 실수 타입에도 들어갈 수 있다.
		long _long=2000000000L;
		float _float= _long;
