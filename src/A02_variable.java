...
public class A02_variable {
	...
	public static void main(String[]args) {
		...
		// 일반인들이 알고 있는 =의미 : 왼쪽 값과 오른쪽 값이 같다 
		// 프로그래밍 에서 =의 의미 : 왼쪽의 변수에 오른쪽의 값을 넣어라 (대입)
		a=10;
		...
		//자바에서는 선언하지 않은 변수는 사용할수 없다.
		
//		b=33;
//		System.out.println("");
//		
		//#변수를 선언하는 여러가지 방법
		int num1;//num1라는 변수를 선언
		...
		//변수를 선언한뒤 맨 처음 값을 대입하는것을 '초기화'라고 부른다.
		num1= 123;//변수 num1가 123으로 초기화됨
