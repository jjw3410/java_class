...
public class E05_StreamToObject {
 ...
 static class Apple implements Serializable{
	...
	//#ObjectOutputStream/ObjectInputStream을 통해 객체도 Stream으로 지나 다닐수 있다
	...
	public static void main(String[] args) {
		...
		//AutoClosable 인터페이스가 구현된 클래스들은 try-with-resources를 이용할수있다
		try (
		...
		//ObjectInputStream의 readObject는 데이터로 Object타입으로 받아오기때문에 제대로 사용하기 위해서는 다운캐스팅이 필요하다
