...
//	}
	...
	public static void main(String[] args) {
		...
		//[a-zA-Z] ¼Ò¹®ÀÚ ´ë¹®ÀÚ µÑ´Ù
		
		//[]:ÇØ´ç À§Ä¡ÀÇ ÇÑ±ÛÀÚ¿¡ ¾î¶² ¹®ÀÚµéÀÌ ¿Ã¼öÀÖ´ÂÁö Á¤ÀÇÇÑ´Ù.
		...
		//	1. Exp{n}: ¾Õ¿¡ ÀÖ´Â ÆĞÅÏÀÌ n±ÛÀÚ Àû¿ëµÈ´Ù
		//	2. Ex{n,m}: ¾Õ¿¡ ÀÖ´Â ÆĞÅÏÀÌ ÃÖ¼Ò n±ÛÀÚÀÌ»ó m±ÛÀÚ Àû¿ëµÇ¾î¾ßÇÔ
		//  3. Ex{n,}: ¾Õ¿¡ ÀÖ´Â ÆĞÅÏÀÌ ÃÖ¼Ò n±ÛÀÚ ÀÌ»ó Àû¿ë ÀÏÄ¡ÇØ¾ß ÇÑ´Ù
		//  4. Ex? : 0¹ø È¤Àº ÇÑ¹ø
		//  5. Ex+:	ÃÖ¼Ò ÇÑ¹ø ÀÌ»ó 
		//  6. Ex*: 0¹ø È¤Àº ¿©·¯¹ø
		System.out.println(Pattern.matches("....[\\d]{4}", "abas1234"));
		System.out.println("À¯È¿ÇÑ ¾ÆÀÌµğ:"+Pattern.matches("[\\w°¡-ÆR]{2,12}", "aÇÑs1234"));
		...
		// - Àü´ŞÇÑ ¹®ÀÚ¿­ÀÌ Á¤±ÔÇ¥Çö½Ä ÀÏÄ¡ÇÏ¸é true
		...
		// - ¹®ÀÚ¿­À» Ã³À½ºÎÅÍ ³¡±îÁö °Ë»çÇÏ¸é¼­ ÇØ´ç Á¤±ÔÇ¥Çö½Ä°ú ÀÏÄ¡ÇÏ´Â ÀÎµ¦½º¸¦ Ã£Àº°á°ú
